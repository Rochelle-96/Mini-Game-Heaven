...
<hr>1) 스트라이크(S)는 맞추는 사람이 부르는 세자리 수 중에서 정답의 같은 자리와 수까지 같은 경우이다.<br>
<hr>2) 볼(B)은 맞추는 사람이 입력한 세자리 수 중에서 정답에 숫자만 있는 경우이다.<br>
<hr>3) 아웃(O)은 1볼(B), 1스트라이크(S)도 없는 경우이다.<br>
