...
<b>1) 스트라이크(S)는 맞추는 사람이 부르는 세자리 수 중에서 정답의 같은 자리와 수까지 같은 경우이다.<br>
<b>2) 볼(B)은 맞추는 사람이 입력한 세자리 수 중에서 정답에 숫자만 있는 경우이다.<br>
<b>3) 아웃(O)은 1볼(B), 1스트라이크(S)도 없는 경우이다.<br>
<b>4. 3스트라이크(3S, 임의의 숫자 세자리 수를 맞춘 경우)일 때 게임이 끝난다.<br><br>
